...
public class FolderConfig{
	...
	public FolderConfig(ConfigAPI configapi, String fileName, String SubFolderName, String FolderName){
		if(!fileName.contains(".yml")){
			fileName = fileName + ".yml";
		}
		this.configapi = configapi;
		this.FolderName = "plugins" + File.separator.toString() + FolderName + File.separator.toString() + SubFolderName.toString();
		this.file = new File(this.FolderName, fileName);
		this.filen = fileName;
		
		if(!this.file.exists()){
			configapi.getServer().getConsoleSender().sendMessage("[ConfigAPI] " + ChatColor.RED.toString() + ChatColor.BOLD.toString() + fileName + ChatColor.GREEN.toString() + " was not found in folder " + ChatColor.RED + this.FolderName + ChatColor.GREEN.toString() +", Generating one!");
			try {
	...
	public void saveAndUnload(){
		this.file = null;
		this.config = null;
		this.file = new File(this.FolderName, filen);
		this.config = YamlConfiguration.loadConfiguration(this.file);
	}
